            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                class="fa fa-arrow-left"></i></a>Currencies : <a class="btn btn-sm btn-outline-secondary"
                            href="{{route('currency.create')}}"><i class="icon-plus"></i> Create Currency</a> </h2>
                    <ul class="float-left breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('admin')}}"><i class="icon-home"></i></a></li>
                        <li class="breadcrumb-item">Currency</li>
                        {{-- <li class="breadcrumb-item active">Add users</li> --}}
                    </ul>
                    <p class="float-right"> Total Currencies : {{$currency->count()}}</p>
                </div>
            </div>
        </div>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <form class="float-left ml-1"
                                                        action="{{route('currency.destroy', $item->id)}}" method="post">
                                                        @csrf
                                                        @method('delete')
