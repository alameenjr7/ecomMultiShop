        ...
        <div class="navbar-right">
            ...
            <div id="navbar-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{route('calendar')}}" class="icon-menu d-none d-sm-block d-md-none d-lg-block">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu user-menu menu-icon">
                            ...
                            <li><a href="{{route('settings')}}"><i class="icon-note"></i> <span>Settings</span></a></li>
                            <li><a href="{{route('profile')}}"><i class="icon-equalizer"></i>
                                    <span>Profile</span></a></li>
                            <li class="menu-heading">BILLING</li>
                            <li><a href="{{route('payment')}}"><i class="icon-credit-card"></i> <span>Payments Settings</span></a>
                            </li>
                            <li><a href="{{route('smtp')}}"><i class="icon-printer"></i> <span>SMTP Settings</span></a>
                            </li>
                        </ul>
                    </li>
