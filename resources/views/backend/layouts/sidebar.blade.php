            ...
            <div class="tab-pane active" id="menu">
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu">
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-picture"></i> <span>Banner Management</span></a>
                            <ul>
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-grid"></i> <span>Category Management</span></a>
                            <ul>
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-handbag"></i> <span>Brand Management</span></a>
                            <ul>
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-briefcase"></i> <span>Products Managements</span></a>
                            <ul>
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-directions"></i> <span>Shipping Managements</span></a>
                            <ul>
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-vector"></i> <span>Post Category</span></a>
                            <ul>
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-tag"></i> <span>Post Tag</span></a>
                            <ul>
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-paper-clip"></i> <span>Post Management</span></a>
                            <ul>
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-star"></i> <span>Review Management</span></a>
                            <ul>
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-check"></i> <span>Coupon Management</span></a>
                            <ul>
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-users"></i> <span>User Management</span></a>
                            <ul>
                        ...
                        <li class="desactive">
                            <a href="#Dashboard" class="has-arrow"><i class="icon-bubbles"></i> <span>Comment Management</span></a>
                            <ul>
