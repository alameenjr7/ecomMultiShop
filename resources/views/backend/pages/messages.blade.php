                                ...
                                <ul class="list-unstyled">
                                    <li class="clearfix">
                                        ...
                                        <div class="mail-detail-right">
                                            <h6 class="sub"><a href="javascript:void(0);" class="mail-detail-expand">Herman Beck</a> <span class="mb-0 badge badge-default">Marketing</span></h6>
                                ...
                                <div class="detail-header">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <p class="mb-0"><strong class="text-muted m-r-5">From:</strong><a class="text-default" href="javascript:void(0);">info@thememakker.com</a> <span class="float-right text-sm text-muted">12:48, 23.06.2018</span></p>
